...
#ifndef IMPLTMENT_STL_MY_MULTIMAP_H
#define IMPLTMENT_STL_MY_MULTIMAP_H
...
namespace mystl {
    ...
    public:
        ...
        pair<iterator, bool> insert(const value_type &x) {
            return _m_t.insert_equal(x);
        }

        iterator insert(iterator position, const value_type &x) {
            return _m_t.insert_equal(position, x);
        }
...
#endif //IMPLTMENT_STL_MY_MULTIMAP_H

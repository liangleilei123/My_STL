...
#ifndef IMPLTMENT_STL_MY_HASH_SET_H
#define IMPLTMENT_STL_MY_HASH_SET_H
...
namespace mystl {
    template<class _Value, class _HashFcn, class _EqualKey, class _Alloc = alloc>
    class hash_set {

    private:
        typedef hashtable<_Value, _Value, _HashFcn, identity<_Value>, _EqualKey, _Alloc> _Ht;
        _Ht _M_ht;      //哈希表是底层容器
...
#endif //IMPLTMENT_STL_MY_HASH_SET_H
